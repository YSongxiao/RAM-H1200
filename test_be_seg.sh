...
EXPERIMENTS=(
    # "Baseline_BESeg_UMambaEnc::--model UMambaEnc --checkpoint ./ckpts/Baseline_BESeg_umambaenc_20260405030303"
    # "Baseline_BESeg_SwinUMamba::--model SwinUMamba --checkpoint ./ckpts/Baseline_BESeg_swinumamba_20260405040404"
)
