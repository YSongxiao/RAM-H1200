...
EXPERIMENTS=(
    ...
    "Baseline_BESeg_New_UMambaEnc::--model UMambaEnc --checkpoint ./ckpts/Baseline_BESeg_DiceCE_New_umambaenc_20260413034353 --save_overlay --save_npz"
    "Baseline_BESeg_New_SwinUMamba::--model SwinUMamba --checkpoint ./ckpts/Baseline_BESeg_DiceCE_New_swinumamba_20260413013145 --save_overlay --save_npz"
    "Baseline_BESeg_New_SwinUNETR::--model SwinUNETR --checkpoint ./ckpts/Baseline_BESeg_DiceCE_New_swinunetr_20260413043334 --save_overlay --save_npz"
    "Baseline_BESeg_New_TransUnet::--model TransUnet --checkpoint ./ckpts/Baseline_BESeg_DiceCE_New_transunet_20260413064250 --save_overlay --save_npz"
    "Baseline_BESeg_New_UNet::--model Unet --checkpoint ./ckpts/Baseline_BESeg_DiceCE_New_unet_20260413084618 --save_overlay --save_npz"
    "Baseline_BESeg_New_Unet++::--model Unet++ --checkpoint ./ckpts/Baseline_BESeg_DiceCE_New_unet++_20260413093330 --save_overlay --save_npz"
    "Baseline_BESeg_New_SegFormer::--model SegFormer --checkpoint ./ckpts/Baseline_BESeg_DiceCE_New_segformer_20260413002722 --save_overlay --save_npz"
