...
def build_svdh_jsn_scoring_context(inputs, save_dir, save_name):
    ...
    payload = {
        ...
        "scoring_rule": (
            "Score joint space narrowing only for this single cropped anatomical site under the "
            "Sharp/van der Heijde SvdH JSN system. Use an integer score from 0 to 4. "
            "Do not score bone erosion, osteophytes, soft tissue swelling, or global disease activity."
        ),
